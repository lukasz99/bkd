...
@Entity
@DiscriminatorValue("erep")
public class EdgeReport extends Report{
    ...
    public static EdgeReport fromJsonForm( String form,
                                           CvTerm freportType,
                                           Source source ){

        Logger log = LogManager.getLogger( EdgeReport.class );
        ...
        try{
            ...
            Edge tgtEdge = new Edge();
            //tgtEdge.setEdge( new Edge() );
    ...
    public String toString(){
        ...
        if( edge != null ){
            return "Edge:" + edge.toString() + " : " + super.toString();
        } else {
