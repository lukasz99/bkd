...
@Table(name = "dataitem")
public class BkdDataItem implements BkdAclAware {

    @Id
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="dataitem_pkey_seq")
    @SequenceGenerator( name="dataitem_pkey_seq", sequenceName="dataitem_pkey_seq",
                        allocationSize=1 )
    @Column(name = "pkey")
    private Long pkey;
   ...
   //--------------------------------------------------------------------------
    ...
    @JoinTable( name = "dataitem_ausr", 
                joinColumns = { @JoinColumn(name = "item_id") }, 
                inverseJoinColumns = { @JoinColumn(name = "ausr_id") } )        
    ...
    @ManyToMany( fetch = FetchType.EAGER, cascade = CascadeType.ALL )
    @JoinTable( name = "dataitem_agrp", 
                joinColumns = { @JoinColumn(name = "item_id") }, 
                inverseJoinColumns = { @JoinColumn(name = "agrp_id") } )
