...
CREATE TABLE alias (
    pkey bigint DEFAULT nextval(('"alias_pkey_seq"'::text)::regclass) NOT NULL CONSTRAINT alias_fk PRIMARY KEY,   
...
CREATE INDEX xref_02 ON xref USING btree (ac,cvtype);
CREATE INDEX xref_03 ON xref USING btree (cvtype);
