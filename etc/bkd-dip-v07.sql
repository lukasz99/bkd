...
-- dataitem table: attachments

CREATE TABLE dataitem (
    pkey bigint DEFAULT nextval(('"dataitem_pkey_seq"'::text)::regclass) NOT NULL CONSTRAINT dataitem_pk PRIMARY KEY,
    sclass character varying(32) DEFAULT ''::character varying,
    
    fk_owner bigint DEFAULT 0 NOT NULL,   
    fk_report bigint DEFAULT 0 NOT NULL,   

    fk_state bigint DEFAULT 0 NOT NULL,   
...
CREATE SEQUENCE dataitem_pkey_seq START WITH 1 INCREMENT BY 1
    NO MINVALUE NO MAXVALUE CACHE 1;

CREATE INDEX dataitem_01 ON node USING btree (sclass);
CREATE INDEX dataitem_02 ON node USING btree (sclass,format);
CREATE INDEX dataitem_03 ON node USING btree (label);
CREATE INDEX dataitem_04 ON node USING btree (t_cr);

CREATE TABLE dataitem_ausr (
       pkey int DEFAULT nextval(('"dataitem_ausr_seq"'::text)::regclass) NOT NULL CONSTRAINT dataitem_ausr_pk PRIMARY KEY,
       item_id int DEFAULT 0 NOT NULL,
       ausr_id int DEFAULT 0 NOT NULL
);

CREATE SEQUENCE dataitem_auser_seq START WITH 1 INCREMENT BY 1
    NO MINVALUE NO MAXVALUE CACHE 1;

CREATE INDEX dataitem_auser_pkey1 ON usr_grp USING btree (item_id);
CREATE INDEX dataitem_auser_pkey2 ON usr_grp USING btree (item_id, ausr_id);
CREATE INDEX dataitem_auser_pkey3 ON usr_grp USING btree (ausr_id, item_id);

CREATE TABLE dataitem_agrp (
       pkey int DEFAULT nextval(('"dataitem_agrp_seq"'::text)::regclass) NOT NULL CONSTRAINT dataitem_agrp_pk PRIMARY KEY,
       item_id int DEFAULT 0 NOT NULL,
       agrp_id int DEFAULT 0 NOT NULL
);

CREATE SEQUENCE dataitem_agrp_seq START WITH 1 INCREMENT BY 1
    NO MINVALUE NO MAXVALUE CACHE 1;

CREATE INDEX dataitem_agrp_pkey1 ON usr_grp USING btree (item_id);
CREATE INDEX dataitem_agrp_pkey2 ON usr_grp USING btree (item_id, agrp_id);
CREATE INDEX dataitem_agrp_pkey3 ON usr_grp USING btree (agrp_id, item_id);

-- textitem: comments & logs

CREATE TABLE textitem (
    pkey bigint DEFAULT nextval(('"textitem_pkey_seq"'::text)::regclass) NOT NULL CONSTRAINT textitem_pk PRIMARY KEY,
    sclass character varying(32) DEFAULT ''::character varying,
...
CREATE SEQUENCE textitem_pkey_seq START WITH 1 INCREMENT BY 1
    NO MINVALUE NO MAXVALUE CACHE 1;

CREATE INDEX textitem_01 ON node USING btree (sclass);
CREATE INDEX textitem_02 ON node USING btree (sclass,format);
CREATE INDEX textitem_03 ON node USING btree (label);
CREATE INDEX textitem_04 ON node USING btree (t_cr);


CREATE SEQUENCE textitem_auser_seq START WITH 1 INCREMENT BY 1
    NO MINVALUE NO MAXVALUE CACHE 1;

CREATE TABLE textitem_ausr (
       pkey int DEFAULT nextval(('"textitem_ausr_seq"'::text)::regclass) NOT NULL CONSTRAINT textitem_ausr_pk PRIMARY KEY,
       item_id int DEFAULT 0 NOT NULL,
       ausr_id int DEFAULT 0 NOT NULL
);

CREATE INDEX textitem_auser_pkey1 ON usr_grp USING btree (item_id);
CREATE INDEX textitem_auser_pkey2 ON usr_grp USING btree (item_id, ausr_id);
CREATE INDEX textitem_auser_pkey3 ON usr_grp USING btree (ausr_id, item_id);

CREATE TABLE textitem_agrp (
       pkey int DEFAULT nextval(('"textitem_agrp_seq"'::text)::regclass) NOT NULL CONSTRAINT textitem_agrp_pk PRIMARY KEY,
       item_id int DEFAULT 0 NOT NULL,
       agrp_id int DEFAULT 0 NOT NULL
);

CREATE INDEX textitem_agrp_pkey1 ON usr_grp USING btree (item_id);
CREATE INDEX textitem_agrp_pkey2 ON usr_grp USING btree (item_id, agrp_id);
CREATE INDEX textitem_agrp_pkey3 ON usr_grp USING btree (agrp_id, item_id);
